...
//  system dynamics
void simulateSystem(double &position, double &velocity, double c_output)
{
    velocity += c_output * dt;
...
int main()
{
    ...
    printf("\033[?7l"); //escape sequence to avoid text wrapping on the left side of the terminal
    ...
    printf("\nThe AutoTuned Values of Kp,Ki,Kd are %.2f,%.2f,%.2f",Kp,Ki,Kd);
